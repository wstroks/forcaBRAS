...
var palavras = [['amarelo', 'cor'], ['manga','fruta'],
                ...
                ['faca', 'objeto que corta os alimentos'],
                ...
                ['borracha', 'objeto que apaga erros'],
